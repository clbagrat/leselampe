        ...
        ? [
            {
              ...
              content:
                ...
                "For separable verbs: Check if the clicked word is part of a separable verb construction where the prefix is separated from the verb in the sentence. This applies to both conjugated verbs AND separated prefixes. If found, set has_detached_prefix=true, provide the OTHER part in detached_prefix_word (exact text from sentence), and provide the combined infinitive in combined_word. Examples: (1) clicking 'steigen' in 'Sie steigen aus' → detached_prefix_word='aus', combined_word='aussteigen'. (2) clicking 'aus' in 'Sie steigen aus' → detached_prefix_word='steigen', combined_word='aussteigen'. (3) clicking 'schauen' in 'schauen sich an' → detached_prefix_word='an', combined_word='anschauen'. (4) clicking 'an' in 'schauen sich an' → detached_prefix_word='schauen', combined_word='anschauen'. The translation should be for the combined word. " +
                "Use empty strings when lemma/article/gender/case cannot be determined.",
            },
            {
              role: "user",
              content: `Translate the German word to Russian and explain its declension or case choice succinctly in Russian, referencing the specific sentence context. Also explain how the word form differs from its lemma (tense, case, number, or other change). IMPORTANT: Check carefully if this word is part of a separable verb where the prefix has been separated in the sentence. Look for common separable prefixes like 'ab', 'an', 'auf', 'aus', 'ein', 'mit', 'nach', 'vor', 'zu', etc. that might be elsewhere in the same clause. If found, identify the other part and provide the combined infinitive.\nWord: ${text}\nSentence: ${context || "N/A"}`,
            },
          ]
        : [
            {
