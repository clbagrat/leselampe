...
const SUPPORTED_UI_LANGS = ["en", "ru", "tr"];
const UI_COPY = {
  en: {
    ...
    "translation.sheet.tip": "Swipe this panel in any direction.",
  ...
  ru: {
    ...
    "translation.sheet.tip": "Смахните панель в любую сторону.",
  ...
  tr: {
    "app.title": "Leselampe — Almanca Okuyucu",
    "app.pages": "Sayfalar",
    "app.action.home": "Kütüphaneye git",
    "screen.library": "Almanca okuyucu",
    "screen.reader": "Okuyucu",
    "screen.lemmas": "Lemmalar",
    "screen.trainings": "Antrenmanlar",
    "screen.settings": "Ayarlar",
    "library.hint.rss": "RSS akışı",
    "library.hint.stories": "Hikâyeleriniz",
    "library.section.stories": "Hikâyeleriniz",
    "library.section.rss": "RSS akışı",
    "library.title.stories": "Hikâyeleriniz",
    "library.title.rss": "RSS akışı",
    "library.subtitle.stories": "Bir metne dokunarak okuyucuda açın.",
    "library.empty.stories": "Henüz metin yok. Okumaya başlamak için ilk hikâyenizi ekleyin.",
    "library.action.add_story": "Yeni hikâye ekle",
    "rss.subtitle": "Abone olduğunuz akışlardaki okunmamış yazılar.",
    "rss.empty": "Okumaya başlamak için bir akış ekleyin.",
    "rss.action.add_feed": "Akış ekle",
    "reader.action.font": "Yazı tipi",
    "reader.action.listen": "Dinle",
    "reader.action.stop": "Durdur",
    "reader.action.play_audio": "Sesi oynat",
    "reader.action.stop_audio": "Sesi durdur",
    "reader.action.finish": "Okumayı bitirdim",
    "reader.status.read": "Okundu olarak işaretlendi.",
    "lemmas.section": "Lemmalar",
    "lemmas.title": "Lemmalar",
    "lemmas.helper":
      "Bir kelimeyi çevirdiğinizde lemmaları takip ediyoruz. Yeni hikâyeler en sık lemmaları eklemeye çalışır; eklenenler öğrenilmiş olur.",
    "lemmas.search.placeholder": "Lemmalarda ara...",
    "lemmas.to_learn": "Öğrenilecek lemmalar",
    "lemmas.empty": "Henüz lemma yok. Takip etmek için bir kelime çevirin.",
    "lemmas.learned": "Öğrenilmiş lemmalar",
    "lemmas.learned.empty": "Henüz öğrenilmiş lemma yok.",
    "lemmas.action.export": "Dışa aktar",
    "lemmas.action.export.copied": "Kopyalandı",
    "lemmas.action.clear": "Geçmişi temizle",
    "trainings.section": "Antrenmanlar",
    "trainings.title": "Antrenmanlar",
    "trainings.subtitle": "Haller, artikeller ve sıfat ekleri için kısa alıştırmalar.",
    "trainings.action.back": "Kapat",
    "trainings.action.next": "Sonraki",
    "trainings.action.skip": "Atla",
    "trainings.action.explain": "Açıkla",
    "trainings.action.abort": "İptal",
    "trainings.status.loading": "Yeni cümleler oluşturuluyor...",
    "trainings.status.ready": "Yeni set hazır.",
    "trainings.status.failed": "Yeni cümleler oluşturulamadı.",
    "trainings.status.api_required": "Üretmek için ayarlarda API anahtarı ekleyin.",
    "trainings.status.completed": "Tüm cümleler öğrenildi. Yeni bir set oluşturun.",
    "trainings.status.session_complete": "Antrenman tamamlandı.",
    "trainings.status.explain_loading": "Açıklama oluşturuluyor...",
    "trainings.status.explain_failed": "Açıklama oluşturulamadı.",
    "trainings.count.label": "{count} cümle",
    "trainings.status.need_generate": "Daha fazla cümle oluşturuluyor...",
    "trainings.status.generating_short": "Oluşturuluyor",
    "trainings.summary.title": "Antrenman tamamlandı",
    "trainings.summary.score": "Doğru: {percent}%",
    "trainings.summary.note": "Hatalı cümleler gelecekteki antrenmanlarda tekrar gelir.",
    "trainings.explain.title": "Açıklama",
    "trainings.action.close": "Kapat",
    "trainings.item.label": "Antrenman",
    "training.dativ_akk.title": "Dativ mi Akkusativ mi",
    "training.dativ_akk.description": "Önce hali, sonra artikeli seçin.",
    "training.adj_endings.title": "Sıfat Ekleri",
    "training.adj_endings.description": "Hali ve sıfat ekini seçin.",
    "training.case.nominative": "Nominativ",
    "training.case.dative": "Dativ",
    "training.case.accusative": "Akkusativ",
    "training.gender.masculine": "Eril",
    "training.gender.feminine": "Dişil",
    "training.gender.neuter": "Nötr",
    "training.gender.plural": "Çoğul",
    "training.feedback.correct_case": "Doğru. Şimdi artikeli seçin.",
    "training.feedback.correct_article_partial": "Güzel. Sonraki artikel.",
    "training.feedback.wrong_case": "Tam değil. Diğer hali deneyin.",
    "training.feedback.correct_article": "Harika. Cümle tamamlandı.",
    "training.feedback.wrong_article": "Tam değil. Başka bir artikel deneyin.",
    "training.feedback.correct_case_ending": "İyi. Şimdi eki seçin.",
    "training.feedback.wrong_case_ending": "Tam değil. Başka bir hal deneyin.",
    "training.feedback.correct_ending": "Harika. Cümle tamamlandı.",
    "training.feedback.correct_ending_partial": "Güzel. Sonraki ek.",
    "training.feedback.wrong_ending": "Tam değil. Başka bir ek deneyin.",
    "translation.tap_word": "Bir kelimeye dokun",
    "translation.tap_word_sentence": "Bir kelimeye veya cümleye dokun",
    "translation.placeholder": "Çeviri burada görünecek.",
    "translation.legend.gender": "cinsiyeti belirleyen",
    "translation.legend.case": "hali belirleyen",
    "translation.grammar.placeholder": "Çekim notları burada görünecek.",
    "translation.morphology.label": "Morfolojik yapı",
    "translation.morphology.placeholder": "Morfolojik analiz burada görünecek.",
    "translation.morphology.part": "Parça",
    "translation.morphology.category": "Kategori",
    "translation.morphology.function": "İşlev",
    "translation.morphology.loading": "Analiz ediliyor...",
    "translation.morphology.empty": "Analiz yok.",
    "translation.morphology.category.Praefix": "Önek",
    "translation.morphology.category.Wurzel": "Kök",
    "translation.morphology.category.Wortstamm": "Gövde",
    "translation.morphology.category.Suffix": "Sonek",
    "translation.morphology.category.Endung": "Çekim eki",
    "translation.morphology.category.Fugenelement": "Bağlayıcı öğe",
    "translation.meta.lemma": "Sözlük biçimi",
    "translation.meta.head": "Baş kelime",
    "translation.meta.article": "Artikel",
    "translation.meta.gender": "Cinsiyet",
    "translation.meta.case": "Hal",
    "translation.swipe.add": "Lemmalara ekle",
    "translation.swipe.ignore": "Yok say",
    "translation.sheet.tip": "Bu paneli herhangi bir yöne kaydırın.",
    "translation.action.copy": "Kelimeyi kopyala",
    "translation.action.skip": "Ekleme",
    "translation.action.listen": "Almancayı dinle",
    "translation.action.ask": "Sor",
    "translation.ask.placeholder": "Bir soru sorun",
    "translation.ask.send": "Gönder",
    "translation.ask.hint": "Bu cümledeki kelime hakkında bir soru sorun.",
    "translation.ask.no_word": "Sormak için okuyucuda bir kelime seçin.",
    "translation.ask.no_api": "Soru sormak için ayarlarda API anahtarı ekleyin.",
    "translation.ask.context.word": "Kelime",
    "translation.ask.context.sentence": "Cümle",
    "translation.ask.error": "Yanıt alınamadı. Tekrar deneyin.",
    "translation.ask.quick.meanings": "Başka anlamları neler?",
    "translation.ask.quick.examples": "Diğer kullanım örnekleri",
    "translation.ask.quick.special": "Bu kelimeyi özel yapan nedir?",
    "translation.ask.quick.structure": "Cümlenin yapısını açıkla",
    "translation.ask.quick.sentence.syntax": "Cümlenin söz dizimini çözümle",
    "translation.ask.quick.sentence.paraphrase": "Aynısını başka sözlerle söyle",
    "translation.ask.quick.sentence.simplify": "Bu cümleyi sadeleştir",
    "translation.report.action": "Sorun bildir",
    "translation.report.sending": "Gönderiliyor...",
    "translation.report.sent": "Bildirildi",
    "translation.report.failed": "Başarısız",
    "translation.report.prompt": "Neyi geliştirmeliyiz? (isteğe bağlı)",
    "translation.report.no_data": "Önce çevrilen bir kelime veya cümle seçin.",
    "translation.report.missing_endpoint": "Bildirim uç noktası henüz yapılandırılmadı.",
    "settings.desktop_warning":
      "Bu web sitesi hareket halindeyken en iyi deneyim için yalnızca mobil ekranlar için geliştirildi. Masaüstünden ziyaret ettiğiniz için teşekkürler — burada bazı düzen ayrıntıları hatalı görünebilir.",
    "settings.section.reader": "Okuyucu ayarları",
    "settings.section.rss": "RSS yöneticisi",
    "settings.section.appearance": "Okuyucu görünümü",
    "settings.title": "Ayarlar",
    "settings.api.label": "ChatGPT API anahtarı",
    "settings.api.placeholder": "sk-...",
    "settings.api.help":
      "API anahtarınızı <a href=\"https://platform.openai.com/api-keys\" target=\"_blank\" rel=\"noopener noreferrer\">OpenAI Platform</a> üzerinden alın",
    "settings.api.validating": "Doğrulanıyor...",
    "settings.language.label": "Diliniz",
    "settings.language.en": "İngilizce",
    "settings.language.ru": "Rusça",
    "settings.language.tr": "Türkçe",
    "settings.rss.title": "Akışları yönet",
    "settings.rss.placeholder": "https://example.com/feed.xml",
    "settings.rss.search_placeholder": "Siteye veya makale URL'sine göre ara",
    "settings.rss.attribution": "Feedsearch tarafından",
    "settings.rss.storage": "Aboneliklerinizi bu tarayıcıda yerel olarak saklıyoruz.",
    "settings.rss.thumbnails": "Küçük resimleri göster",
    "settings.rss.empty": "Henüz akış yok.",
    "settings.appearance.title": "Okuyucu görünümü",
    "settings.appearance.reader_font": "Okuyucu yazı tipi",
    "settings.appearance.font.serif": "Serif",
    "settings.appearance.font.sans": "Sans",
    "settings.appearance.reader_size": "Okuyucu boyutu",
    "settings.appearance.line_spacing": "Satır aralığı",
    "settings.appearance.spacing.tight": "Sıkı",
    "settings.appearance.spacing.loose": "Geniş",
    "settings.appearance.hyphenation": "Heceleme",
    "settings.appearance.sentence_per_line": "Satır başına bir cümle",
    "settings.appearance.toggle.on": "Açık",
    "settings.appearance.toggle.off": "Kapalı",
    "settings.appearance.justification": "Hizalama",
    "settings.appearance.justify.left": "Sola",
    "settings.appearance.justify.justify": "İki yana yasla",
    "modal.add_story.title": "Yeni hikâyeler ekle",
    "modal.add_story.mode.generate": "Hikâye oluştur",
    "modal.add_story.mode.paste": "Metni yapıştır",
    "modal.add_story.mode.shadowing": "Gölgeleme",
    "modal.add_story.word_amount": "Kelime sayısı",
    "modal.add_story.level": "Seviye",
    "modal.add_story.style": "Stil",
    "modal.add_story.style.casual": "Gündelik",
    "modal.add_story.style.literary": "Edebi",
    "modal.add_story.prompt": "Hikâye istemi",
    "modal.add_story.prompt_placeholder": "Yağmurlu bir günde bir öğrenci hakkında kısa bir hikâye, seviye A2.",
    "modal.add_story.helper": "Yukarıdaki ChatGPT API anahtarınızı kullanır.",
    "modal.shadowing.audio_label": "Ses dosyası",
    "modal.shadowing.action.add": "Kütüphaneye ekle",
    "modal.shadowing.status.transcribing": "Yazıya dönüştürülüyor...",
    "modal.shadowing.status.generating_title": "Başlık oluşturuluyor...",
    "modal.shadowing.status.failed": "Bu ses çözümlenemedi.",
    "modal.shadowing.status.failed_detail": "Çözümlenemedi: {message}",
    "modal.shadowing.status.no_audio": "Eklenecek bir ses dosyası seçin.",
    "modal.shadowing.status.too_large": "Ses dosyası yerel olarak saklamak için çok büyük.",
    "modal.paste.title": "Başlık",
    "modal.paste.title_placeholder": "Başlığınız",
    "modal.paste.body_label": "Almanca metin",
    "modal.paste.body_placeholder": "Almanca metni buraya yapıştırın.",
    "modal.paste.action.add": "Okuyucuya ekle",
    "modal.scan.input_label": "Fotoğraf",
    "modal.scan.action.scan": "Metni tara",
    "modal.scan.status.scanning": "Taranıyor...",
    "modal.scan.status.done": "Metin hazır.",
    "modal.scan.status.no_text": "Bu fotoğrafta metin bulunamadı.",
    "modal.scan.status.failed": "Bu fotoğraf taranamadı.",
    "scan.default_title": "Taranmış metin",
    "shadowing.default_title": "Gölgeleme ses kaydı",
    "modal.appearance.title": "Okuyucu görünümü",
    "modal.appearance.font": "Yazı tipi",
    "modal.appearance.size": "Boyut",
    "action.add": "Ekle",
    ...
    "action.show": "Göster",
    "action.hide": "Gizle",
    "action.clear_key": "Anahtarı temizle",
    "action.save": "Kaydet",
    "action.close": "Kapat",
    "action.suggest": "Öner",
    "action.generate": "Oluştur",
    "rss.search.enter_url": "Akış aramak için bir URL girin.",
    "rss.search.searching": "Aranıyor...",
    "rss.search.empty": "Akış bulunamadı.",
    "rss.search.unreachable": "feedsearch.dev'e ulaşılamadı.",
    "rss.search.add": "Ekle",
    "rss.search.remove": "Kaldır",
    "rss.search.feed": "Akış",
    "rss.subscriptions.remove": "Kaldır",
    "rss.feed.empty_items": "Henüz öğe yok.",
    "rss.feed.untitled_post": "Başlıksız gönderi",
    "rss.feed.loading": "Yükleniyor...",
    "rss.feed.abort": "İptal",
    "rss.feed.mark_read": "Okundu olarak işaretle",
    "rss.feed.mark_unread": "Okunmadı olarak işaretle",
    "rss.feed.source": "Akış",
    "rss.reader.no_text": "Bu makale için okunabilir metin bulunamadı.",
    "rss.reader.loading_article": "Makale yükleniyor...",
    "rss.reader.loading_article_level": "{level} için uyarlanıyor...",
    "rss.reader.no_text_available": "Okunabilir metin yok.",
    "rss.reader.add_key": "RSS makalelerini uyarlamak için bir API anahtarı ekleyin.",
    "rss.reader.adapt_failed": "Bu makale uyarlanamadı.",
    "rss.reader.extract_failed": "Makale metni çıkarılamadı.",
    "rss.reader.load_failed": "Makale içeriği yüklenemedi.",
    "rss.reader.canceled": "İptal edildi.",
    "rss.load_errors": "{count} akış yüklenemedi{plural}.",
    "rss.list.empty": "Okumaya başlamak için bir akış ekleyin.",
    "rss.list.loading": "Akışlar yükleniyor...",
    "rss.manager.paste": "Eklemek için bir akış URL'si yapıştırın.",
    "rss.manager.invalid_url": "Geçerli bir URL girin.",
    "reader.status.learned": "Öğrenildi: {lemmas}",
    "story.no_preview": "Önizleme yok.",
    "story.untitled": "Başlıksız",
    "story.mark_read": "Okundu olarak işaretle",
    "story.mark_unread": "Okunmadı olarak işaretle",
    "story.delete": "Sil",
    "story.add": "Yeni hikâye ekle",
    "lemma.delete": "Lemmayı sil",
    "lemma.no_matches": "Eşleşme yok.",
    "lemma.mark_learned": "Öğrenildi olarak işaretle",
    "lemma.mark_unlearned": "Öğrenilecek olarak işaretle",
    "translation.loading": "Çevriliyor...",
    "translation.explaining": "Açıklanıyor...",
    "translation.no_declension": "Bu kelime için çekim açıklaması yok.",
    "translation.sentence_only":
      "Çekim notları yalnızca tek tek kelimeler için kullanılabilir.",
    "translation.placeholder_ru": "Çeviri burada görünecek.",
    "translation.copy.word": "Kelimeyi kopyala",
    "translation.copy.sentence": "Cümleyi kopyala",
    "settings.api.required": "API anahtarı gerekli",
    "settings.api.invalid": "Geçersiz API anahtarı",
    "settings.api.failed": "API anahtarı doğrulanamadı. Lütfen bağlantınızı kontrol edin.",
    "settings.reset.confirm":
      "Tüm veriler (hikâyeler, lemmalar, RSS, antrenmanlar ve okuyucu ayarları) sıfırlansın mı? API anahtarınız korunacak.",
    "prompt.suggesting": "Öneriliyor...",
    "prompt.generating": "Oluşturuluyor...",
    "prompt.generate": "Oluştur",
    "paste.default_title": "Özel metin",
    "story.default_title": "Yeni hikâye",
  },
};
